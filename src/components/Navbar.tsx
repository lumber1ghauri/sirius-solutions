...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 w-full bg-white dark:bg-gray-800 shadow-md z-50 transition-colors duration-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-20">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            >
              {theme === 'dark' ? (
                <svg className="w-5 h-5 text-gray-600 dark:text-yellow-300" fill="currentColor" viewBox="0 0 20 20">

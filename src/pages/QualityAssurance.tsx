...
import { ArrowLeft, Shield, Bug, TestTube, CheckCircle, Zap, Eye, Target, Users, Star, Code, Settings, FileText, Activity, Lock } from 'lucide-react'
      ...
      <div className="relative z-10 pt-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl text-gray-300 max-w-4xl mx-auto leading-relaxed">
            Our comprehensive quality assurance process ensures your software meets the highest 
